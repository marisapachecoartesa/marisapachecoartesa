    ...
    return (
        <div className={`flex flex-col min-h-screen items-center bg-light text-black text-xl justify-between overflow-hidden ${inter.className}`}>
          ...
          <div className='mt-40 w-full md:w-1/3 container conteiner'>
            <h1 className='text-center text-3xl'>Faça sua encomenda!</h1>
            <input className='w-full mt-6 p-2 rounded' placeholder='Seu nome' id='nome' type='text' value={nome} onChange={handleNomeChange} />
            ...
            <a className='underline mt-3 text-center justify-center flex items-center' target='_blank' href={`https://wa.me/5511973165808?text=Olá, meu nome é ${nome}. ${mensagem}`}>
